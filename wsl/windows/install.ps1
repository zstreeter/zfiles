...
# (SSO and device-management agents). Deleting those needs admin, hits every user of
...
# release, and some managed networks refuse that download. See the header of
...
#
# --scope user is load-bearing, not tidiness. On a domain-joined machine whose
# account is NOT in the local Administrators group, a
